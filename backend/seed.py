...
users = [
    # RTO Admin
    {
        ...
        "password": "rto",
        "role": "RTO",
        "displayName": "Regional Transport Office",
...
print("\nAccounts seeded:")
for u in users:
    print(f"  {u['role']:8s} | {u['username']:10s} | {u['displayName']:28s} | {u['walletAddress']}")
